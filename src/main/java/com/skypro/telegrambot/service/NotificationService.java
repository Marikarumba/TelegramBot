...
import com.skypro.telegrambot.model.NotificationTask;
import com.skypro.telegrambot.repository.NotificationTaskRepository;
...
public class NotificationService {
    ...
    public void sendNotifications() {
        notificationTaskRepository.findByLocalDateTimeEquals(LocalDateTime.now()
                .truncatedTo(ChronoUnit.MINUTES)).forEach(task -> {
            telegramBot.execute
                    (new SendMessage(task.getChatId(), task.getNotificationText()));
        });
    }
